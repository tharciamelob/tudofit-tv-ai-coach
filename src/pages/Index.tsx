...
const Index = () => {
  ...
  const workoutCategories = [
    ...
    },
    {
      ...
      workouts: [
        { id: "31", title: "Como Usar a Esteira Corretamente", duration: "15 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.9, isNew: true },
        { id: "32", title: "Supino - Técnica Perfeita", duration: "20 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.8 },
        { id: "33", title: "Leg Press - Execução Segura", duration: "18 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.7 },
        { id: "34", title: "Puxador Alto - Variações", duration: "22 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.6 },
        { id: "35", title: "Smith Machine - Guia Completo", duration: "25 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.8 },
        { id: "tut1", title: "Agachamento Livre - Forma Correta", duration: "20 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.9 },
        { id: "tut2", title: "Barra Fixa - Progressões", duration: "25 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.8 },
        { id: "tut3", title: "Remada Curvada - Técnica", duration: "18 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.7 },
        { id: "tut4", title: "Desenvolvimento - Ombros", duration: "22 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.6 },
        { id: "tut5", title: "Deadlift - Levantamento Terra", duration: "30 min", calories: "0 cal", difficulty: "Avançado" as const, rating: 4.9 },
        { id: "tut6", title: "Rosca Bíceps - Variações", duration: "15 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.5 },
        { id: "tut7", title: "Tríceps Pulley - Execução", duration: "12 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.6 },
        { id: "tut8", title: "Abdominais na Máquina", duration: "16 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.7 },
        { id: "tut9", title: "Panturrilha no Smith", duration: "14 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.4 },
        { id: "tut10", title: "Crucifixo - Peito", duration: "18 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.6 },
        { id: "tut11", title: "Cadeira Extensora", duration: "15 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.5 },
        { id: "tut12", title: "Mesa Flexora", duration: "17 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.6 },
        { id: "tut13", title: "Elevação Lateral", duration: "12 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.7 },
        { id: "tut14", title: "Voador - Peitoral", duration: "16 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.5 },
        { id: "tut15", title: "Cabo Cross Over", duration: "20 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.8 },
        { id: "tut16", title: "Hack Squat - Posicionamento", duration: "19 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.7 },
        { id: "tut17", title: "Stiff - Posterior de Coxa", duration: "16 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.6 },
        { id: "tut18", title: "Paralelas - Mergulho", duration: "18 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.8 },
        { id: "tut19", title: "Remada Sentado", duration: "15 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.6 },
        { id: "tut20", title: "Abdução de Quadril", duration: "13 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.5 },
        { id: "tut21", title: "Adução de Quadril", duration: "13 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.4 },
        { id: "tut22", title: "Glúteo Quatro Apoios", duration: "16 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.7 },
        { id: "tut23", title: "Bicicleta Ergométrica", duration: "12 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.3 },
        { id: "tut24", title: "Transport - Elíptico", duration: "14 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.4 },
        { id: "tut25", title: "Remo Indoor - Técnica", duration: "18 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.6 },
        { id: "tut26", title: "Corda Naval - Uso Correto", duration: "15 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.7 },
        { id: "tut27", title: "Kettlebell - Fundamentos", duration: "22 min", calories: "0 cal", difficulty: "Intermediário" as const, rating: 4.8 },
        { id: "tut28", title: "TRX - Setup e Básico", duration: "20 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.6 },
        { id: "tut29", title: "Bosu - Exercícios Base", duration: "17 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.5 },
        { id: "tut30", title: "Medicine Ball - Uso Prático", duration: "16 min", calories: "0 cal", difficulty: "Iniciante" as const, rating: 4.6 }
      ]
    },
    {
